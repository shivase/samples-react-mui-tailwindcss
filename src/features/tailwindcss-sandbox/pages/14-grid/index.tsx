  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3">
        <div className="border border-blue-600 bg-blue-100 p-10 md:col-span-2 md:row-span-2">
          Item 1
        </div>
        ...
        <div className="col-span-2 border border-blue-600 bg-blue-100 p-10">Item 7</div>
        <div className="border border-blue-600 bg-blue-100 p-10">Item 8</div>
        <div className="border border-blue-600 bg-blue-100 p-10 md:col-span-3">Item 9</div>
      </div>
